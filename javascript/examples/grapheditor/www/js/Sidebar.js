...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	var fns = [
		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>开始</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '开始',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>放音</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '放音',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>菜单</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '菜单',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>转接</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '转接',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>收号</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '收号',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>识别</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '识别',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>判断</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '判断',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>子流程</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '子流程',
			null, null, dt + 'object instance'),

		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
			160, 90, '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>挂断</b></p><hr/>' +
			'<p style="margin:0px;margin-left:8px;">节点ID: KS-001</p>', '挂断',
			null, null, dt + 'object instance'),
	];
